...
tree_old = function(taxon=NULL, collapse=NULL, max_tips=300, ...) {

	# df = prepare_tree_data(taxon=taxon, collapse=collapse)
	df = tree_data(taxon=taxon, collapse=collapse)

	plot_tree_data_old(df, max_tips=max_tips, ...)
...
plot_tree_data_old = function(df, max_tips=100, textsize=3, xmin=NULL, xmax=NULL) {
