...
df = tibble::tribble(
	...
	"abelisauridae", -143, -66, "abelisaurus, carnotaurus", "'Abel's lizards'",
	"abelisaurus", 80, NA, NA, "'Abel's lizard'. South America.",
	"acanthostega", -365, -365, NA, "'spiny roof'",
	"aepyornithiformes", -2.58, -0.001, NA, " elephant birds, incl Aepyornis",
	"aetosauria", -231.4, -201.4, "aetosaurus, desmatosuchus", "'eagle lizards'",
	"aetosaurus*", -227.3, -205.7, NA, "'eagle lizard'",
	"afrotheria", -65, 0, "proboscidea, sirenia", 'incl. golden moles, elephant shrews, otter shrews, tenrecs, aardvarks, hyraxes, elephants, sea cows',
	"alamosaurus", -70, -66, NA, "'Ojo Alamo lizard', named after the geologic formation it was found in. The only known titanosaur from North America.",
	"albertosaurus", -71, -68, NA, "'Alberta lizard'. North America.",
	"alioramus", -70, -70, NA, "'different branch'. Asia.",
	"alligator", -37.2, 0, NA, NA,
	"alligatoroidea", -83.6, 0, "alligator, caiman, deinosuchus", NA,
	"allosauridae", -179.17, -145, "allosaurus", NA,
	"allosaurus", -155, -143.1, NA, "'different lizard'",
	"alvarezsauridae", -97, -66, "alvarezsaurus", "'Alvarez's lizards'",
	# "alvarezsauroidea", -160, -66, NA, NA,
	"alvarezsaurus", -86, -83, NA, "'Alvarez's lizard'. Argentina.",
	...
	"gymnophiona", -223, 0, NA, "caecilians",
	...
	"proboscidea", -60, 0, "phiomia, moeritherium, deinotheriidae, gomphotheriidae, mammutidae, stegodontidae, elephantidae", NA,
	"deinotheriidae", -28, -1, "deinotherium", "'Terrible beasts'",
	"deinotherium*", -13, -1, NA, "'Terrible beast'. East Africa, Europe, India. Tusks grew down and curved back from lower jaw.",
	"stegodontidae", 17.3, -0.01, 'stegodon', NA,
	"mammutidae", -27.5, -0.011, 'mammut', 'incl. Mastodons',
	"mammut", -8, -0.011, NA, "Aka mastodon ('nipple tooth').",
	"gomphotheriidae", -28, -0.01, "gomphotherium", "'Nail beasts'",
	"gomphotherium", -16, -5, NA, "'Nail beast'. Eurasia, Africa, North America. Double set of straight tusks",
	"moeritherium", -37, -35, NA, "'The beast from Lake Moeris'. North and West Africa.",
	"phiomia", 37, 30, NA, "North Africa",
	...
	"stegocephalia*", -380, 0, "tetrapoda, acanthostega, elginerpeton, ichthyostega, tiktaalik", NA,
	...
	"tetrapoda*", -360, 0, "lepospondyli, reptiliomorpha, temnospondyli", NA,
	"tetrapodomorpha", -409, 0, "stegocephalia", NA,
	...
	# fish
	'sarcopterygii', 425, 0 , 'tetrapodomorpha', 'lobe-finned fish',
	'osteichthyes*', 430, 0, 'actinopterygii, sarcopterygii', 'bony fishes',
	'actinopterygii', 425, 0, NA, 'ray-finned fish',
	'chondrichthyes', 439, 0, 'elasmobranchii', 'cartilaginous fish',
	'elasmobranchii*', 439, 0, NA, 'rays, skates, and sawfish',
	'gnathostomata*', 445, 0, 'chondrichthyes, osteichthyes, placodermi', 'jawed vertbrates',
	'placodermi', 439, 358.9, NA, "'plate skin'",
) |>
...
df |>
	...
	dplyr::rename(children=.data$children_string) |>
...
# 		df$from[i],
# 		df$to[i],
# 		df$children_string[i] %>% {ifelse(length(.) == 0, NA, paste0('"', ., '"'))},
